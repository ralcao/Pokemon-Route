...
pokemon(83,  farfetchd, [normal, flying]).
...
pokemon(122,  mr_mime, [psychic, fairy]).
pokemon(89,  muk, [poison]).
pokemon(34,  nidoking, [poison, ground]).
pokemon(31,  nidoqueen, [poison, ground]).
pokemon(29,  nidoran_female, [poison]).
pokemon(32,  nidoran_male, [poison]).
